...
{
    public class BuyTipSession: Session<List<BuyTipInfo_Session>>
    {
        public BuyTipSession()
        {
            Name = "BuyTipSession";
            dataKey = "BuyTipSession";
            username = "mealTicket_baseData";
        }
        public override List<BuyTipInfo_Session> UpdateSession()
        {
