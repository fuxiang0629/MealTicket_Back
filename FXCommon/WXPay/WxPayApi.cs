...
namespace WxPayAPI
{
    public class WxPayApi
    {
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, string key, int timeOut = 6)
        {
            ...
            ReportCostTime(url, timeCost,key, result);//测速上报
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, string key, string SSlCertPath,string SSlCertPassword, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(xml, url, true, timeOut,SSlCertPath,SSlCertPassword);
        ...
        */
        public static WxPayData Refund(WxPayData inputObj,string key, string SSlCertPath, string SSlCertPassword, int timeOut = 6)
        {
            ...
            else if (!inputObj.IsSet("appid"))
            {
                throw new WxPayException("退款申请接口中，缺少必填参数appid！");
            }
            else if (!inputObj.IsSet("mch_id"))
            {
            ...
            string response = HttpService.Post(xml, url, true, timeOut, SSlCertPath, SSlCertPassword);//调用HTTP通信接口提交数据到API
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData RefundQuery(WxPayData inputObj,string key, int timeOut = 6)
	    {
            ...
            {
                throw new WxPayException("退款查询接口中，appid必填！");
            }
            if (!inputObj.IsSet("mch_id"))
            {
                throw new WxPayException("退款查询接口中，mch_id必填！");
            }
		    inputObj.SetValue("nonce_str",GenerateNonceStr());//随机字符串
            inputObj.SetValue("sign_type", WxPayData.SIGN_TYPE_MD5);//签名类型
            inputObj.SetValue("sign", inputObj.MakeSign(key));//签名
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj,string key, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData ShortUrl(WxPayData inputObj,string key, int timeOut = 6)
	    {
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, string key, int timeOut = 6)
        {
            ...
            else if (!inputObj.IsSet("notify_url"))
            {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData CloseOrder(WxPayData inputObj,string key, int timeOut = 6)
	    {
	    ...
	    */
        private static void ReportCostTime(string interface_url, int timeCost,string key, WxPayData inputObj)
	    {
		    //如果不需要进行上报
