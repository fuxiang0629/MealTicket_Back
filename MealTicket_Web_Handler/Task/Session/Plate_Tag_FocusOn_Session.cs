...
namespace MealTicket_Web_Handler
{
    ...
    then insert(Market,SharesCode,PlateId,IsFocusOn,[Date]) values(t1.Market, t1.SharesCode, t1.PlateId, t1.IsFocusOn, '{0}');", dateNow.ToString("yyyy-MM-dd"));
        ...
        public static Plate_Tag_FocusOn_Session_Obj UpdateSessionPart(object newData)
        {
            ...
            resultData.Shares_Plate_FocusOn_Session = Singleton.Instance.sessionHandler.GetPlate_Tag_FocusOn_Session();
            resultData.Plate_Shares_FocusOn_Session = Singleton.Instance.sessionHandler.GetPlate_Tag_FocusOn_Session_ByPlate();
