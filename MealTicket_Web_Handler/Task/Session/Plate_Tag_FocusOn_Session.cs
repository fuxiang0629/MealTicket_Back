...
namespace MealTicket_Web_Handler
{
    public class Plate_Tag_FocusOn_Session
    {
        ...
        public static Dictionary<long, Dictionary<long, Plate_Tag_FocusOn_Session_Info>> UpdateSessionPart(object newData)
        {
            ...
            var oldDic = Singleton.Instance.sessionHandler.GetPlate_Tag_FocusOn_Session();
            //深度拷贝
            var oldData = Utils.DeepCopyWithBinarySerialize<Dictionary<long, Dictionary<long, Plate_Tag_FocusOn_Session_Info>>>(oldDic);
