...
namespace MealTicket_Web_Handler
{
    public class Shares_Energy_Table_Session
    {
        ...
        public static Dictionary<long, Shares_Energy_Table_Session_Info> Cal_Shares_Energy_Table() 
        {
            ...
            var shares_quotes_last = Singleton.Instance.sessionHandler.GetShares_Quotes_Last_Session(false, false);

            int minRiseRate = Singleton.Instance.LeaderMinRiseRate;
            ...
            foreach (var share in leaderShares)
            {
                ...
                var lastQuotes = shares_quotes_last[share].shares_quotes_info;
                if (lastQuotes == null)
                {
                    continue;
                }
